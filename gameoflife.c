...
int main(int argc, char *argv[]) {
  ...
  //free(b);
  /*
  printf("We are at 23 = %d \n" , cells_grid[2][3].current);
  printf("Left up Neighbour: %d:    ", cells_grid[2][3].neighbours[0]->current );
  printf("Up Neighbour: %d:    ", cells_grid[2][3].neighbours[1]->current );
  printf("Right Up Neighbour: %d:    \n", cells_grid[2][3].neighbours[2]->current );
  printf("Left Neighbour: %d:    ", cells_grid[2][3].neighbours[3]->current );
  printf("Right Neighbour: %d:    \n", cells_grid[2][3].neighbours[4]->current );
  printf("Left down Neighbour: %d:    ", cells_grid[2][3].neighbours[5]->current );
  printf("Down Neighbour: %d:    ", cells_grid[2][3].neighbours[6]->current );
  printf("Right down Neighbour: %d:    \n", cells_grid[2][3].neighbours[7]->current );
